...
links = {
    ...
    "rel190": Relationship(
        source=Node(id="Heart Disease", type="Disease"),
        target=Node(id="Blood Pressure", type="Condition"),
        type="INCREASES",
    ),
    "rel191": Relationship(
    ...
    "rel197": Relationship(
        source=Node(id="Job Satisfaction", type="Condition"),
        target=Node(id="Productivity", type="Condition"),
        type="INCREASES",
    ),
    "rel198": Relationship(
        source=Node(id="Diet", type="Aspect"),
        target=Node(id="Stress", type="Condition"),
        type="INFLUENCES",
    ),
    "rel199": Relationship(
    ...
    "rel203": Relationship(
        source=Node(id="Stress", type="Condition"),
        target=Node(id="Heart Disease", type="Condition"),
        type="INCREASES_RISK",
    ),
    "rel204": Relationship(
        source=Node(id="Stress", type="Concept"),
        target=Node(id="Physical Activity", type="Behavior"),
        type="DECREASES",
    ),
    "rel205": Relationship(
        source=Node(id="Physical Activity", type="Activity"),
    ...
    "rel212": Relationship(
        source=Node(id="Stress", type="Condition"),
        target=Node(id="Social Support", type="Factor"),
        type="DECREASES",
    ),
    "rel213": Relationship(
        source=Node(id="Mental Health", type="Health aspect"),
    ...
    "rel216": Relationship(
        source=Node(id="Stress", type="Condition"),
        target=Node(id="Social Relationships", type="Condition"),
        type="DETERIORATES",
    ),
    "rel217": Relationship(
        source=Node(id="Burnout", type="Condition"),
    ...
    "rel221": Relationship(
        source=Node(id="Inflammation", type="Biological process"),
        target=Node(id="Heart Disease", type="Disease"),
        type="CONTRIBUTES_TO",
    ),
    "rel222": Relationship(
    ...
    "rel227": Relationship(
        source=Node(id="Stress", type="Condition"),
        target=Node(id="Diet", type="Factor"),
        type="INFLUENCED_BY",
    ),
    "rel228": Relationship(
        source=Node(id="Stress", type="Condition"),
        target=Node(id="Memory", type="Condition"),
        type="IMPAIRS",
    ),
    "rel229": Relationship(
        source=Node(id="Blood Pressure", type="Condition"),
    ...
    "rel239": Relationship(
        source=Node(id="Stress", type="Condition"),
        target=Node(id="Exercise", type="Activity"),
        type="REDUCED_BY",
    ),
    "rel240": Relationship(
        source=Node(id="Cortisol", type="Hormone"),
    ...
    "rel245": Relationship(
        source=Node(id="Smoking", type="Lifestyle"),
        target=Node(id="Stress", type="Condition"),
        type="INCREASES",
    ),
    "rel246": Relationship(
    ...
    "rel266": Relationship(
        source=Node(id="Stress", type="Concept"),
        target=Node(id="Job Satisfaction", type="Psychological factor"),
        type="DECREASES",
    ),
    "rel267": Relationship(
        source=Node(id="Stress", type="Condition"),
        target=Node(id="Mental Health", type="Aspect"),
        type="AFFECTS",
    ),
    "rel268": Relationship(
        source=Node(id="Social Support", type="Activity"),
    ...
    "rel270": Relationship(
        source=Node(id="Stress", type="Condition"),
        target=Node(id="Learning", type="Condition"),
        type="IMPAIRS",
    ),
    "rel271": Relationship(
        source=Node(id="Alcohol Consumption", type="Activity"),
    ...
    "rel287": Relationship(
        source=Node(id="Stress", type="Condition"),
        target=Node(id="Sleep Quality", type="Aspect"),
        type="DECREASES",
    ),
    "rel288": Relationship(
        source=Node(id="Diet", type="Activity"),
